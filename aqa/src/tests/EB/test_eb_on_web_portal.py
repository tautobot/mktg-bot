...
excel_file = f'{path.fixture_dir}/eb_template.xlsx'

class Test(BaseTest):

    def setUp_fixture(self):
        self.employee_email = read_cell_in_excel_file(excel_file, 'G2')
        self.employee_pwd   = account.default_pwd
        set_default_password(self.employee_email)
        kyc(self.employee_email)

        self.dashboard_login                        = DashboardLoginPage(self.driver)
        self.dashboard_home_page                    = DashboardHomePage(self.driver)
        self.dashboard_add_new_user_page            = DashboardAddNewUserPage(self.driver)
    ...
    def test_verify_eb_benefits(self):
        self.setUp_fixture()
        ...
        self.web_portal_home_page.click_on_eb_product()
        wait_for_loading_venta(self.driver)
        ...
        assert member_id  == read_cell_in_excel_file(excel_file, 'K2')
    ...
    def test_claim_ip_on_web_portal(self):
        ...
        self.web_portal_claim_page.choose_eb_product()
